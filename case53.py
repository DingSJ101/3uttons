...
class mySolution(NewSolution):
    ...
    def left(self,state,controls):
        state[1],state[2],state[3],state[11],state[10] ,state[9] = state[11],state[10],state[9],state[1],state[2],state[3]
        return self.check(state),controls

    def right(self,state,controls):
        state[5],state[6],state[7],state[15],state[14] ,state[13] = state[15],state[14],state[13],state[5],state[6],state[7]
        return self.check(state),controls
